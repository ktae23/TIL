...
<head>
    ...
    <link rel="stylesheet" href="assets/lib/codemirror/dracula.min.css">
...
<body>
    ...
    <script src="assets/lib/codemirror/clike.min.js"></script>
    <script>
