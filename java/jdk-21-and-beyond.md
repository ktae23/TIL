...
JDK 21(LTS)부터 최신 버전까지의 주요 기능과 변경사항을 정리한다. 각 버전별 핵심 기능과 실제 코드 예시를 포함한다.

## 목차

- [버전별 릴리스 개요](#버전별-릴리스-개요)
- [JDK 21 (LTS) - 2023년 9월](#jdk-21-lts---2023년-9월)
- [JDK 22 - 2024년 3월](#jdk-22---2024년-3월)
- [JDK 23 - 2024년 9월](#jdk-23---2024년-9월)
- [JDK 24 - 2025년 3월](#jdk-24---2025년-3월)
- [버전별 주요 기능 비교](#버전별-주요-기능-비교)
...
| 버전 | 릴리스 | 유형 | 주요 특징 |
|------|--------|------|----------|
| **JDK 21** | 2023-09 | **LTS** | Virtual Threads, Pattern Matching, Sequenced Collections |
| **JDK 22** | 2024-03 | Non-LTS | Unnamed Variables, FFM API, Stream Gatherers (Preview) |
| **JDK 23** | 2024-09 | Non-LTS | Primitive Patterns (Preview), Markdown Doc Comments |
| **JDK 24** | 2025-03 | Non-LTS | Stream Gatherers 정식, Compact Object Headers |
...
> ⚠️ **주의**: String Templates는 JDK 23에서 Preview가 철회되었다.
