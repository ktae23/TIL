import { Schema, NodeSpec, MarkSpec, Fragment } from 'static/toast-editor/editor/types/prosemirror-model';
...
import {
  ...
  HTMLToken,
  HTMLConvertorMap,
} from 'static/toast-editor/editor/types/toastmark';
import { Emitter, Handler } from 'static/toast-editor/editor/types/event';
import { Context, EditorAllCommandMap, EditorCommandFn, SpecManager } from 'static/toast-editor/editor/types/spec';
import { ToMdConvertorMap } from 'static/toast-editor/editor/types/convertor';
import { ToolbarItemOptions, IndexList } from 'static/toast-editor/editor/types/ui';
import { CommandFn, PluginInfo } from 'static/toast-editor/editor/types/plugin';
import { HTMLMdNode } from 'static/toast-editor/editor/types/markdown';
